...
class BookingFormBlock extends PhpBlock
{
    ...
    public function extraVars()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            ...
            $values = [
                ...
                'booked_tour' => Yii::$app->menu->current->getAlias(),
            ];
    ...
    */
    ...
    {
        return '<h3 class="mb-0 bg-secondary p-2 rounded text-light"><b>Booking Form Block</b><i class="material-icons float-right">' . $this->icon() . '</i></h3><hr class="mb-2">' .
            '<p>Booking form is auto generated by the Booking Module.</p>';
    }
}